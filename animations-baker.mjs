...
import {getAvatarHeight, getModelBones, modelBoneToAnimationBone} from './utils/util.mjs';
...
(async () => {
  ...
  (async () => {
    ...
    await baker('http://localhost:9998/', fbxFileNames, vpdFileNames, animationsResultFileName).catch(e => {
